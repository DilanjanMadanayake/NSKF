              ...
              <div class="panel panel-default">
                  ...
                  <div class="panel-body">
                    ...
                    <div class="col-md-12">
                        ...
                        <?php echo form_open('chief_instructor/add_privileges/'.$id) ?>
                    <table class="table">
                        ...
                        <tr>
                            <td>Privileges :</td>
                            <td><textarea rows="5" name="privilege" class="form-control" id="address" placeholder="Add Privilege"><?php echo set_value('privilege'); ?></textarea></td>                           
                        </tr>
                        <tr>
                            <td><button type="submit" name="submit" class="btn btn-primary">Add Privilege</button></td>
                            <td></td>
                        </tr>
                        <?php } ?>
                    </table>
