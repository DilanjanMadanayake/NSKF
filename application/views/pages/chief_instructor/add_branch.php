                            ...
                            <div class="panel panel-default">
                                ...
                                <div class="panel-body">
                                    <div class="row">
                                        ...
                                        <div class="col-sm-10">
                                            <?php echo form_open('chief_instructor/add_branch'); ?>   
                                            <?php 
                if($status == 1){
                    echo
                    "<div class=\"row\">
                ...
                ?>
                                            <table width="500" border='0' cellpadding='0' cellspacing='0'>
                                                ...
                                                <tr>
                                                    ...
                                                    <td><textarea name="address" class="form-control"><?php echo set_value('address'); ?></textarea>
                                                        <span class="help-block" style="color: crimson"> <?php echo form_error('address'); ?></span></td>
                                                </tr>
                                                <tr>
                                                    <td><?php echo 'Assign Instructor'; ?></td>
                                                            <td>
                                                                <select name="branch_lead_id" class="form-control" id="branch_lead_id" onchange="this.form.submit()">
