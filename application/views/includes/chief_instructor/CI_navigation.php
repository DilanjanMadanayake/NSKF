        ...
        <div class="navbar navbar-inverse navbar-fixed-top animated fadeInDown" role="navigation" id="top-nav">
          <div class="container">
            <div class="navbar-header">
              <!-- Logo Starts -->
              <a class="navbar-brand" href="<?php echo base_url("chief_instructor/index")?>"><img src="<?php echo base_url("../images/logo.png");?>" height="30" alt="logo"/></a>
              <!-- Logo Ends -->
...
<!--              <button type="button" class="navbar-toggle collapsed" data-toggle="collapse" data-target=".navbar-collapse">
            ...
            <div class="navbar-collapse  collapse">
              ...
              <ul class="nav navbar-nav navbar-right" >
                 ...
                 <li><a href="signup_form.php"></a></li>
                 <li><a href="../user/member_login.php"><span class="glyphicon glyphicon-play-circle"></span><b> Log Out</b></a></li>
              </ul> 
